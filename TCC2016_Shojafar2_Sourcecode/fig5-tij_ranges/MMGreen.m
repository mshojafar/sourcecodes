...
save('Results_ScnerioM50N100F1Q3.mat','total_energyt1','tot_reconfig_Energy1',...
...
Results=load('Results_ScnerioM50N100F1Q3.mat','total_energyt1','tot_reconfig_Energy1',...
        'Opt_Comm_Energyt1','Opt_Comp_Energyt1','Total_Time','time_meanWL_M', 'time_meanWL');    
...
%%%%%%% simulation plots
figure(2003) %fig 5a
plot(T_vector,time_meanWL_M(:,1),'-bs',T_vector,time_meanWL_M(:,2),'-kd',...
     T_vector,time_meanWL_M(:,3),'-ro',T_vector,time_meanWL_M(:,4),'-k*',...
...
% figure(2003) %fig 5b
% plot(1:1:Q+1,time_meanWL_M(:,1),'-bs',T_vector_range,time_meanWL_M(:,2),'-kd',T_vector_range,time_meanWL_M(:,3),'-ro',T_vector_range,time_meanWL_M(:,3),'-k*','markers',20,'LineWidth',6);
% xlabel('$T/T_t$','Interpreter','latex','FontSize',40);
% ylabel('$\overline{\mathcal{E}}^{CMc}\:(Joule)$','Interpreter','latex','FontSize',40);
% legend('$F_{i1}$','$F_{i2}$','$F_{i3}','$F_{iQ}','Interpreter','latex','FontSize',40);
% title(['M= ' num2str(M) ', N= ' num2str(N) ', F_Q= ' num2str(max(Discrete_F))],'Interpreter','latex','FontSize',30);
% grid on
